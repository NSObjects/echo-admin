...
type IRoleMenuDo interface {
	...
	GetById(id int) (result model.RoleMenu, err error)
	DeleteByID(id int64) (err error)
}

// GetById
// SELECT * FROM @@table WHERE id = @id
func (r roleMenuDo) GetById(id int) (result model.RoleMenu, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM role_menus WHERE id = ? ")
...
func (r roleMenuDo) DeleteByID(id int64) (err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("DELETE * FROM role_menus WHERE id = ? ")
